  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center p-6">
      <div className="max-w-md text-center">
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-amber-100 dark:bg-amber-950/40 mx-auto mb-4">
        ...
        <p className="text-sm text-[var(--brand-muted)] mb-6">
          We couldn&apos;t load the setup wizard. You can continue using the dashboard — this won&apos;t affect your service.
        </p>
